...
public class FavoriteAdapter extends RecyclerView.Adapter implements Filterable {
    private Context context;
    private List<LocationReponseModel> mDataset;
    private List<LocationReponseModel> contactListFiltered;

    public FavoriteAdapter(Context applicationContext, List<LocationReponseModel> categoery) {
