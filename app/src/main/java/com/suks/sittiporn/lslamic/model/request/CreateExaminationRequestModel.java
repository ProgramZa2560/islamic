...
public class CreateExaminationRequestModel {
    ...
    private int examination_list_examination_id;
    ...
    private int examination_list_a_score;
    private int examination_list_b_score;
    private int examination_list_c_score;
    private int examination_list_d_score;
    private int examination_list_e_score;

    public int getExamination_list_examination_id() {
        return examination_list_examination_id;
    }

    public void setExamination_list_examination_id(int examination_list_examination_id) {
    ...
    public int getExamination_list_a_score() {
        return examination_list_a_score;
    }

    public void setExamination_list_a_score(int examination_list_a_score) {
        this.examination_list_a_score = examination_list_a_score;
    }

    public int getExamination_list_b_score() {
        return examination_list_b_score;
    }

    public void setExamination_list_b_score(int examination_list_b_score) {
        this.examination_list_b_score = examination_list_b_score;
    }

    public int getExamination_list_c_score() {
        return examination_list_c_score;
    }

    public void setExamination_list_c_score(int examination_list_c_score) {
        this.examination_list_c_score = examination_list_c_score;
    }

    public int getExamination_list_d_score() {
        return examination_list_d_score;
    }

    public void setExamination_list_d_score(int examination_list_d_score) {
        this.examination_list_d_score = examination_list_d_score;
    }

    public int getExamination_list_e_score() {
        return examination_list_e_score;
    }

    public void setExamination_list_e_score(int examination_list_e_score) {
